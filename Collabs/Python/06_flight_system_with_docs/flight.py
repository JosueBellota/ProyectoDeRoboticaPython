...
class Flight:
    """
    Representación de un vuelo con su número y aeronave asociada.

    Attributes:
        number (str): El número de vuelo (ej. "BA117").
        aircraft (Aircraft): La aeronave asignada al vuelo.
        seating (list): La disposición de los asientos y los pasajeros asignados.
    """
    def __init__(self, number, aircraft):
        ...
        Args:
            number (str): El número de vuelo.
            aircraft (Aircraft): La aeronave para este vuelo.
        """
    ...
    def get_seating(self):
        """
        Devuelve la disposición actual de los asientos.

        Returns:
            list: Una lista que representa la disposición de los asientos.
        """
