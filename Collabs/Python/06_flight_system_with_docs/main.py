"""
Módulo principal para la creación y gestión de vuelos.

Este módulo demuestra el uso de las clases Aircraft, Passenger y Flight
para simular la reserva de asientos en vuelos.
"""
